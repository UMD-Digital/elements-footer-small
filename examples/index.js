...
const FEARLESS_LOGO_CONTAINER_CLASS = 'umd-footer-fearless-logo-container';
...
`;
const fearlessSvg = `<svg title="fearless forward logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 656.25 274.98"><defs><style>.b{fill:#fff;}.c{fill:#231f20;}</style></defs><polygon class="c" points="24.35 0 0 153.72 595.12 153.72 619.46 0 24.35 0 24.35 0"/><polygon class="c" points="161.97 124.47 138.13 274.98 632.41 274.98 656.25 124.47 161.97 124.47 161.97 124.47"/><path class="b" d="M190.87,153.88l-14.96,94.31h20.28l6.09-38.79h14.45l3.3-20.03h-14.45l2.53-15.97h18.63l3.17-19.52h-39.04Zm73.02,17.87c2.79,0,3.68,1.9,3.17,5.32l-7.73,48.55c-.38,2.41-1.4,4.44-4.18,4.44s-3.55-2.03-3.17-4.56l7.61-48.43c.63-3.55,1.52-5.32,4.31-5.32h0Zm-1.01-19.14c-16.1,0-22.18,10.27-24.72,26.62l-6.97,43.99c-2.54,16.86,5.45,26.37,21.42,26.37h3.8c13.94,0,21.8-9.38,24.47-25.73l7.1-44.62c2.41-16.1-4.56-26.62-21.42-26.62h-3.68Zm54.38,56.92h2.66c2.91,0,3.55,1.4,2.91,4.82l-4.18,26.75c-.63,3.8,0,6.09,.63,7.1h20.16l.13-.63c-.51-1.52-.89-3.3-.25-6.97l4.82-30.42c1.14-7.61-3.04-11.41-6.09-12.93,4.94-1.65,9-5.96,10.27-14.32l2.03-12.42c1.77-10.9-4.82-16.61-14.07-16.61h-30.42l-14.96,94.31h20.28l6.08-38.66h0Zm6.34-39.42h2.79c2.54,0,3.3,1.4,2.79,4.31l-2.03,12.8c-.38,3.3-1.65,4.56-4.06,4.56h-2.92l3.42-21.68h0Zm69.59-16.23l-13.31,57.17,3.93-57.17h-20.54l-1.9,94.31h23.58l11.03-51.21-2.92,51.21h23.07l25.35-94.31h-20.03l-12.42,58.44,3.17-58.44h-19.01Zm68.58,94.31h19.65l1.9-94.31h-25.1l-26.62,94.31h18l3.42-13.82h9.38l-.63,13.82h0Zm-4.06-32.45l7.1-28.65-1.39,28.65h-5.71Zm62.75-6.21h2.66c2.92,0,3.55,1.4,2.92,4.82l-4.18,26.75c-.63,3.8,0,6.09,.63,7.1h20.16l.13-.63c-.51-1.52-.89-3.3-.25-6.97l4.82-30.42c1.14-7.61-3.04-11.41-6.08-12.93,4.94-1.65,9-5.96,10.27-14.32l2.03-12.42c1.78-10.9-4.82-16.61-14.07-16.61h-30.42l-14.96,94.31h20.28l6.09-38.66h0Zm6.34-39.42h2.79c2.54,0,3.3,1.4,2.79,4.31l-2.03,12.8c-.38,3.3-1.65,4.56-4.06,4.56h-2.92l3.42-21.68h0Zm29.66
2.91c.38-2.54,1.01-3.93,3.3-3.93,2.54,0,3.17,1.52,2.79,4.06l-1.52,9.76h19.39l1.65-10.52c1.9-11.92-3.55-19.65-18.76-19.65h-4.56c-14.07,0-20.92,6.59-22.95,19.27l-.63,3.93c-1.52,9.38,.89,16.73,8.49,26.37l6.09,7.86c3.93,5.07,4.94,7.48,4.06,12.8l-.51,3.17c-.63,3.8-1.78,5.58-4.18,5.58-2.53,0-3.3-1.77-2.79-5.2l2.03-13.06h-19.9l-2.28,14.2c-2.15,14.07,5.96,21.93,19.9,21.93h4.69Zm47.66-95.58l-14.96,94.31h37.01l3.17-20.03h-16.73l11.79-74.29h-20.28Zm84.04,0h-18.76l-9.89,31.31-.13-31.31h-19.78l5.45,58.44-5.71,35.87h20.41l5.58-36.13,22.82-58.19h0Z"/></svg>`;
const icons = {
...
template.innerHTML = `
  <style>
    ...
    @media (min-width: ${Breakpoints.socialIconsTransitionPoint}px) and (max-width: ${Breakpoints.tabletMax}px) {
    ...
    :host .${FEARLESS_LOGO_CONTAINER_CLASS} {
      width: 20%;
      padding-left: 15px;
      margin-left: 15px;
      position: relative;
    ...
    :host .${FEARLESS_LOGO_CONTAINER_CLASS} span {
      content: '';
      position: absolute;
      left: 0;
...
`;
const makeLinkElement = ({ name, url }) => {
...
const makeLogo = () => {
    ...
    const fearlessWrapper = document.createElement('div');
    ...
    fearlessWrapper.classList.add(FEARLESS_LOGO_CONTAINER_CLASS);
    logoLink.innerHTML = logoSvg;
    fearlessWrapper.innerHTML = `<span></span>${fearlessSvg}`;
    container.appendChild(logoLink);
    container.appendChild(fearlessWrapper);
    return container;
};
const makeSocial = ({ socialLinks }) => {
...
const makeContainer = (args) => {
    ...
    const logo = makeLogo();
    const social = makeSocial(Object.assign({}, args));
...
const makeUtilityLinks = ({ addedLinks, }) => {
    const container = document.createElement('div');
    const lock = document.createElement('div');
...
const makeMarkup = (args) => {
    return new Promise((resolve) => {
        const wrapper = document.createElement('div');
        const main = makeContainer(Object.assign({}, args));
        const utility = makeUtilityLinks(Object.assign({}, args));
...
export default class FooterSmall extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (name !== 'padding' && newValue) {
            const currentIndex = this._socialLinks.findIndex((obj) => name === obj.name);
            if (currentIndex >= 0) {
    ...
    connectedCallback() {
        return __awaiter(this, void 0, void 0, function* () {
            const addedLinks = Array.from(this._shadow.host.querySelectorAll('div[slot="links"] a'));
            const markup = yield makeMarkup({
    ...
    sizeUtility() {
        const container = this._shadow.querySelector(`.${UTILITY_CONTAINER_CLASS}`);
        const links = Array.from(container.querySelectorAll(`a, p`));
